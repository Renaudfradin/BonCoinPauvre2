 ...
 */
final class Version20220202223639 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE anonces (id INT AUTO_INCREMENT NOT NULL, user_anonces_id INT NOT NULL, title VARCHAR(255) NOT NULL, description VARCHAR(255) NOT NULL, prix VARCHAR(255) NOT NULL, image VARCHAR(255) NOT NULL, tags VARCHAR(255) NOT NULL, create_post DATETIME NOT NULL, INDEX IDX_D9DF5CB431388D4 (user_anonces_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
